...
public void selectairport_from(){
    w1.until(ExpectedConditions.elementToBeClickable(roundtripRadio));
    roundtripRadio.click();
w1.until(ExpectedConditions.visibilityOf(fromlocationTextbox));
    fromlocationTextbox.click();
  selectAirport.sendKeys("BOM");
...
public void  destination_selectairport(){
    ...
    destinSelectAirport.sendKeys("DEL");
...
public Roundtrip_page(WebDriver driver){
    this.driver=driver;
